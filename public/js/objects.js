ssmap.prototype.objects = function(data) {
    ...
    this.addStar = function(pos) {
        ...
        //Создаем материал
        material = new THREE.ParticleBasicMaterial( { size: 315, map: texture, transparent: true } );
    ...
    this.addOrbit = function(pos, radius)
    {
        ...
        for(var i = 0; i <= resolution; i++) {
            ...
            geometry.vertices.push( new THREE.Vector3( Math.cos( segment ) * radius, Math.sin( segment ) * radius ));
        }
